    ...
    <div ref={scrollRef}>
      ...
      >
        ...
        >
          ...
          <h1>
            I'm an Productive, efficient and aspiring Full-stack web developer
            with specialization in MERN stack. With a keen interest and
            curiosity to learn more about computers and technology.
          </h1>
          <div className={styles.btn}>
            <a
              href="https://drive.google.com/file/d/1CGngdIKxP4bhyl8NLfnS331zZGBh4f4E/view?usp=sharing" // Resume
              target="blank"
            >
              <Button
                text={
        ...
        >
          <img
            src="https://avatars.githubusercontent.com/u/87422053?v=4" //my Picture
            alt="Profile pic"
          />
        </div>
      </div>
